...
begin
 ...
 //OutStream.SaveToFile('C:\Users\Dageron\Desktop\tmp');
end;
...
var
  ...
  dwOffset, dwPosition, dwPosition_1, dwPosition_2: DWORD;
begin
  ...
  with m_XTDHeader do   //texture dictionary header reading
    begin
      ...
      if iWorkMode=3 then   //work mode: *.xsf (some of Midnight Club: Los Angelos texture resources)
      begin
        InStream.Seek(0, 0);
  ...
  for I := 1 to m_XTDHeader.dwTextureCount do   //item information blocks reading
    begin
      ...
      if (m_grcTextureXenon._vmt=6163044) then InStream.Seek(StrToInt(tslTextureListOffsets[I-1])+24, 0); //RDR
